                            ...
                            <form action="{{ route('admin.vendor.update',$vendor_edit->id) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" value="{{$vendor_edit->name}}" id="formrow-email-input" placeholder="Enter Your Name" name="name">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="email" name="email" value="{{$vendor_edit->email}}" class="form-control" id="formrow-name-input" placeholder="Enter Your Email ID">
                                            <ul class="parsley-errors-list filled" id="parsley-id-25" aria-hidden="false">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="phone" value="{{$vendor_edit->phone}}" class="form-control" id="formrow-phone-input" placeholder="Enter Your Phone">
                                            <ul class="parsley-errors-list filled" id="parsley-id-25" aria-hidden="false">
                                                @error('phone')
                                                    <li class="parsley-required"> {{ $message }}</li>
                                                @enderror
