<x-adminlayout title="SuperVisor| Edit">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title mb-4">Update SuperVisor</h4>
                            <form action="{{ route('admin.supervisor.update',$visor_edit->id) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" value="{{old('name',$visor_edit->name)}}" id="formrow-email-input" placeholder="Enter Your Name" name="name">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="email" name="email" value="{{old('email',$visor_edit->email)}}" class="form-control" id="formrow-name-input" placeholder="Enter Your Email ID">
                                            <ul class="parsley-errors-list filled" id="parsley-id-25" aria-hidden="false">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="phone" value="{{old('phone',$visor_edit->phone)}}" class="form-control" id="formrow-phone-input" placeholder="Enter Your Phone">
                                            <ul class="parsley-errors-list filled" id="parsley-id-25" aria-hidden="false">
                                                @error('phone')
                                                    <li class="parsley-required"> {{ $message }}</li>
                                                @enderror
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" value="{{old('address_line_2',$address->address_line_2)}}" name="address_line_2" class="form-control" id="formrow-address2-input" placeholder="Enter Your Address Line 2">
                                            <ul class="parsley-errors-list filled" id="parsley-id-25" aria-hidden="false">
                                ...
                                <div class="row">
                                    <div class="col-lg-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="country" value="{{old('country',$address->country)}}" class="form-control" id="formrow-inputCity" placeholder="Enter Your Living Country">
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="mb-3">
